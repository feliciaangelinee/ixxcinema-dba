USE [master]
GO
/****** Object:  Database [IXXCinema_db]    Script Date: 28/03/2020 13:51:37 ******/
...
GO
ALTER DATABASE [IXXCinema_db] SET  ENABLE_BROKER 
GO
...
GO
ALTER DATABASE [IXXCinema_db] SET RECOVERY FULL 
GO
...
GO
EXEC sys.sp_db_vardecimal_storage_format N'IXXCinema_db', N'ON'
GO
ALTER DATABASE [IXXCinema_db] SET QUERY_STORE = OFF
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [SystemAdmin]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [SystemAdmin] WITH PASSWORD=N'jPnUKDSDNB3T2Vz35G1ii03pLUKVWvevHO8QvbjXcEA=', DEFAULT_DATABASE=[IXXCinema_db], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
GO
ALTER LOGIN [SystemAdmin] DISABLE
GO
/****** Object:  Login [NT SERVICE\Winmgmt]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [NT SERVICE\Winmgmt] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT SERVICE\SQLWriter]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [NT SERVICE\SQLWriter] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT SERVICE\SQLTELEMETRY]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [NT SERVICE\SQLTELEMETRY] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT SERVICE\SQLSERVERAGENT]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [NT SERVICE\SQLSERVERAGENT] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT Service\MSSQLSERVER]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [NT Service\MSSQLSERVER] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT AUTHORITY\SYSTEM]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [NT AUTHORITY\SYSTEM] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [DESKTOP-KAG9Q73\ANGIE]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [DESKTOP-KAG9Q73\ANGIE] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [AdminStore]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [AdminStore] WITH PASSWORD=N'5uZ3IdTtvlyMZlNBqtF5qMQ6r3dHc/DnIau5vAcPpp4=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
ALTER LOGIN [AdminStore] DISABLE
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [##MS_PolicyTsqlExecutionLogin##]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [##MS_PolicyTsqlExecutionLogin##] WITH PASSWORD=N'iYJkmIqmBod2wDEB4EPIKsMl9ZhvAn74n9/4Oc9Q6Qw=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
ALTER LOGIN [##MS_PolicyTsqlExecutionLogin##] DISABLE
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [##MS_PolicyEventProcessingLogin##]    Script Date: 28/03/2020 13:51:38 ******/
CREATE LOGIN [##MS_PolicyEventProcessingLogin##] WITH PASSWORD=N'qcln56Ab/UjYAmRAalmvf68PQjvhAQzUP4Pec5Khs7g=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
...
GO
ALTER SERVER ROLE [sysadmin] ADD MEMBER [DESKTOP-KAG9Q73\ANGIE]
GO
USE [IXXCinema_db]
GO
/****** Object:  User [SystemAdmin]    Script Date: 28/03/2020 13:51:38 ******/
CREATE USER [SystemAdmin] FOR LOGIN [SystemAdmin] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  User [CinemaTransactionStaff]    Script Date: 28/03/2020 13:51:38 ******/
...
GO
/****** Object:  Table [dbo].[CinemaTransaction]    Script Date: 28/03/2020 13:51:38 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[MsCinema]    Script Date: 28/03/2020 13:51:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MsMovie]    Script Date: 28/03/2020 13:51:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MsStaff]    Script Date: 28/03/2020 13:51:38 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[CinemaTransaction]  WITH CHECK ADD FOREIGN KEY([CinemaId])
REFERENCES [dbo].[MsCinema] ([CinemaId])
GO
ALTER TABLE [dbo].[CinemaTransaction]  WITH CHECK ADD FOREIGN KEY([MovieId])
REFERENCES [dbo].[MsMovie] ([MovieId])
GO
ALTER TABLE [dbo].[CinemaTransaction]  WITH CHECK ADD FOREIGN KEY([StaffId])
REFERENCES [dbo].[MsStaff] ([StaffId])
GO
ALTER TABLE [dbo].[MsMovie]  WITH CHECK ADD CHECK  (([MovieRating]>=(1) AND [MovieRating]<=(10)))
GO
ALTER TABLE [dbo].[MsStaff]  WITH CHECK ADD CHECK  ((len([StaffName])>=(5)))
GO
USE [master]
GO
